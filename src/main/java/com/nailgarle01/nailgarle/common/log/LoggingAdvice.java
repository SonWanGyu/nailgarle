package com.nailgarle01.nailgarle.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.nailgarle01.nailgarle.*.service.*.*(..)) or " + "execution(* com.nailgarle01.nailgarle.*.dao.*.*(..))")
	...
	@After("execution(* com.nailgarle01.nailgarle.*.service.*.*(..)) or " + "execution(* com.nailgarle01.nailgarle.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.nailgarle01.nailgarle.*.service.*.*(..)) or " + "execution(* com.nailgarle01.nailgarle.*.dao.*.*(..))")
