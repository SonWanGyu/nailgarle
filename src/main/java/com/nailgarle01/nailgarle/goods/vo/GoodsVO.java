...
public class GoodsVO {
	...
	private int p_subNum; 
	private int sellerNum; 
	private int p_mainNum; 
	...
	public int getProductDc() {
		return productDc;
	}
	public void setProductDc(int productDc) {
	...
	public int getP_subNum() {
		return p_subNum;
	}
	public void setP_subNum(int p_subNum) {
		this.p_subNum = p_subNum;
	}
	...
	public int getP_mainNum() {
		return p_mainNum;
	}
	public void setP_mainNum(int p_mainNum) {
		this.p_mainNum = p_mainNum;
	}
