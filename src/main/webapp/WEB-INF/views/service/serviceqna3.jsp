	...
	<div class="layout">
		<div class="service_container">
			...
			<div class="service_main">
				<h4>문의 수정</h4>
				<div class="qnainfo">
					<form action="${contextPath}/service/updateQna.do" method="post"
						...
						<c:if test="${Qna.qnaType != '상품문의' }">
						<input type="hidden" name="productName" value="${Qna.productName }">
						</c:if>
						<table>
							<tr>
								<td id="detail_title">분류</td>
								<td id="detail_title2">
									<input type="text" name="qnaType" value="${Qna.qnaType }" disabled>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td id="detail_title2"><input class="detail_name"
									type="text" name="qnaTitle" value="${Qna.qnaTitle}" required />
								</td>
							</tr>
							<c:if test="${Qna.qnaType == '상품문의' }">
							<tbody id="product_search">
								<tr>
									...
									<td id="detail_title2"><input type="text" id="productName"
										name="productName" value="${Qna.productName}"
										onKeyUp="keywordSearch()" style="width: 300px;"
							...
							<tr>
								...
								<td id="detail_title2"><textarea class="detail_text"
										name="qnaText">${Qna.qnaText}</textarea></td>
							</tr>
