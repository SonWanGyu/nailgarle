	...
	<div class="layout">
		...
		<div class="seller_container">
			...
			<div class="sidebar">
				...
				<form action="${contextPath}/seller/goods/modifyGoods.do"
								...
								<div class="tab_content" id="tab1">
									<table>
										<tr>
											...
											<td><select name="p_mainNum" id="p_mainNum"
												onchange="fn_category(this.value)">
													<option value="1"
														${goods.p_mainNum == '1' ? 'selected="selected"' : '' }>여행가방
														하드/소프트</option>
													<option value="2"
														${goods.p_mainNum == '2' ? 'selected="selected"' : '' }>배낭/보조가방</option>
													<option value="3"
														${goods.p_mainNum == '3' ? 'selected="selected"' : '' }>수납백/편의용품</option>
													<option value="4"
														${goods.p_mainNum == '4' ? 'selected="selected"' : '' }>어댑터/전자</option>
													<option value="5"
														${goods.p_mainNum == '5' ? 'selected="selected"' : '' }>캠핑용품</option>
													<option value="6"
														${goods.p_mainNum == '6' ? 'selected="selected"' : '' }>렌탈</option>
											</select></td>
											<td><input id="mainCategoryName" type="hidden"
												name="mainCategoryName" value="${goods.mainCategoryName }" />
												<input type="hidden" name="productNum"
												value="${goods.productNum }" /></td>
										</tr>
						...
						<table>
							<tr>
								<td align=center>
									...
									<input type="button" value="삭제" onclick="location.href='${contextPath}/seller/goods/deleteGoods.do?productNum=${goods.productNum }'">
