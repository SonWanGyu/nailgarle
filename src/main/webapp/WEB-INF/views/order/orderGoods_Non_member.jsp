...
<!-- body부분 삽입-->
	<div class="orderGoods">
		...
		<table class="order_check">
			<tbody align="center">
				...
				<tr>			
					...
					<td class="redLine"><fmt:formatNumber value="${item.productPrice*item.productQuantity }" />원</td>
					<td><fmt:formatNumber value="${item.productSale*item.productQuantity }" />원</td>
					<c:choose>
				...
				<table>
					<tbody>
						<tr class="dot_line">
							...
							<td>
								<input type="radio" id="delivery_method" name="delivery_method" value="일반택배" checked="checked">일반택배	&nbsp;&nbsp;&nbsp; 
						...
						<tr class="dot_line">
							...
							<td><input type="radio" name="delivery_place" onclick="restore_all()" value="기본배송지" checked="checked">기본배송지
						...
						<tr class="dot_line">
							...
							<td><input type="text" id="zipcode" name="zipcode" size="5" value="34303"> <a href="javascript:execDaumPostcode()">우편번호검색</a>
								<br>
								<p>
									<br>지번 주소: <input type="text" id="roadAddress"  name="roadAddress" size="50" value="대전 대덕구 갑천도시고속도로 336 (문평동)"><br>
									<br> 도로명 주소: <input type="text" id="jibunAddress"	name="jibunAddress" size="50" value="대전 대덕구 문평동 400-4"><br>
									<br> 나머지 주소: <input type="text" id="namujiAddress" name="namujiAddress" size="50" value="ㅁㄴㅇㅁㄴㅇ">
								</p> 
								 <input type="hidden" id="h_zipcode" name="h_zipcode" value="34303">
								 <input type="hidden" id="h_roadAddress" name="h_roadAddress" value="대전 대덕구 갑천도시고속도로 336 (문평동)">
						</tr>
						<tr class="dot_line">
							<td class="fixed_join">배송 메시지</td>
							<td><input id="delivery_message" name="delivery_message" type="text" size="50" placeholder="택배 기사님께 전달할 메시지를 남겨주세요."></td>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<table class="order_check">
				<tbody align="center">
					...
					<tr>				
						...
						<td>400 P</td>
						<td>사용 포인트</td>
						<td><input class="text_box" type="text"/><input type="button" value="확인"/></td>
					</tr>
				</tbody>
		</table>
		</div>
		...
		<div class="order_type">
			<input type="radio" id="p_pay_method" name="pay_method" value="신용카드" checked="checked">신용카드	&nbsp;&nbsp;&nbsp; 
			<input type="radio" id="p_pay_method" name="pay_method" value="무통장 입금">무통장 입금	&nbsp;&nbsp;&nbsp;
			<input type="radio" id="p_pay_method" name="pay_method" value="실시간 계좌이체">실시간 계좌이체 &nbsp;&nbsp;&nbsp;
			<input type="radio" id="p_pay_method" name="pay_method" value="휴대폰 결제">휴대폰 결제 &nbsp;&nbsp;&nbsp;
			<input type="radio" id="p_pay_method" name="pay_method" value="카카오페이">카카오페이 &nbsp;&nbsp;&nbsp;	
			<br>
			<span>카드선택 : </span>
			<select id="card_com_name" name="카드선택">
			...
			<span>할부기간 : </span>
			<select id="card_pay_month" name="할부기간">
		...
		<input type="button" value="결제하기" onclick="fn_process_pay_order()">
		<input type="button" value="취소" onclick="location.href='${contextPath}/main/main.do'">	
	</div>
</div>
</body>
</html>